...
dfs$r1 <- list_assign(dfs$r1, 
                      ...
                      recB = dfs$r1$allB %>% filter(trt.duration > 0))
```
...
ggsurvplot(fit, data = dfs$r1$allB,
  ...
  geom_vline(xintercept = dfs$r1$allB$day.enter, color = "red") +
  geom_vline(xintercept = dfs$r1$allB$day.recover, color = "skyblue") +
  geom_vline(xintercept = dfs$r1$allB$day.return, color = "orange") +
...
ggsurvplot(fit, data = km$data,
  ...
  ## not sure why there's 2 return lines on cohort B/dur 48...
