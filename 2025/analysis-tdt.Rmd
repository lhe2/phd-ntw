...
# TODO make a version for hours

calc.timepointbins <- function(widedata){
  widedata %>% 
...
calc.surv_ss <- function(widedata){
  widedata %>%
    #dfs2$r1$allB %>% # tester data
    calc.timepointbins() %>%
    ...
    summarise(n.surv.enter = sum(status.enter == 1),
              ...
              prop.surv.enter48 = n.surv.enter48/n.surv.enter,
              prop.surv.return = n.surv.return/n.surv.enter48,
              prop.surv.return48 = case_when(trt.duration == 0 ~ n.surv.return48/n.surv.enter48,
