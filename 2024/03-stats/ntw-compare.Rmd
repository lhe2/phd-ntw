...
```{r mumin subsets}
# bc apparently this pkg cant handle NAs
  # all surv to pups
  # all surv to ecs
...
# fit candidate models for pup surv (general, ignoring is.sup)
...
# picking models..
out.psurv <- model.sel(mod.psurv$fullint, mod.psurv$fulladd, mod.psurv$null)
...
so when i google "model.sel vs dredge mumin" apparently i should `dredge` first, pick some nice candidates, then throw them into `model.sel`, see also https://uoftcoders.github.io/rcourse/lec09-model-selection.html#a_more_realistic_example
