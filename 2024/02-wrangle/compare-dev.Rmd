...
ss_devall <- ntw_wide %>%
  ...
  summarise(n.tot = n(),
            ...
            p.sup = round(n.sup/n.dev, digits = 3), # any pup with 6+ instars
            p.5th = round(n.5th/n.dev, digits = 3), # pup in 5... etc
            p.6th = round(n.6th/n.dev, digits = 3),
            p.7th = round(n.7th/n.dev, digits = 3),
            p.8th = round(n.8th/n.dev, digits = 3)
            )
