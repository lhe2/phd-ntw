...
data_tentstats <- read_sheet("https://docs.google.com/spreadsheets/d/1TOUsH7zNT6jF7SltYsD_8pK5tI7yR-Gqx-kDrodmJ00/edit?gid=641809244", sheet = "tent stats", range = "A:P", col_types = "c", na = c("", "#REF!", "#N/A"))
...
write.csv(data_tentstats, paste0("~/Documents/repos/ntw/2024/data/archive/", today, "_clean-fertility"), row.names = FALSE)
```
