...
p1 <- ss_ntw %>% 
  ...
  geom_line() +
  geom_point(size = 2) +
  geom_text(aes(label = n), hjust = -0.25, vjust = -0.5) +
...
//todo
- 2025-02-04: try to group by surv outcome maybe...
...
ss_devall <- ntw_wide %>%
  ...
  summarise(n = n(),
            ...
            p.pmd = round(n.pmd/n.surv, digits = 2),
            p.sup = round(n.sup/n.surv, digits = 2),
            p.5th = round(n.5th/n.surv, digits = 2),
            p.6th = round(n.6th/n.surv, digits = 2),
            p.7th = round(n.7th/n.surv, digits = 2),
            p.8th = round(n.8th/n.surv, digits = 2)
            )
...
ss_devpmd <- ntw_wide %>%
  ...
  summarise(n = n(),
            ...
            p.5th = round(n.5th/n, digits = 2),
            p.6th = round(n.6th/n, digits = 2),
            p.7th = round(n.7th/n, digits = 2),
            p.8th = round(n.8th/n, digits = 2)
            )
```



## - dev time & longevity (by sex)
