...
C_labels = c("267-hatch"="26±7°C (33/19)","40-19"="29.5±10.5°C (40/19)", "337-hatch"="33±7°C (40/26)", "40-33"="36.5±3.5°C (40/33)")
C_hex = c("#F4B942", "#4059AD", "#6B9AC4", "#97D8C4")
C_colors = c("267-hatch"="#F4B942", "40-19"="#4059AD", "337-hatch"="#6B9AC4", "40-33"="#97D8C4")
...
long2 <- data_all %>% filter(trt.stage == "267-hatch" | expt.group == "C") %>%
...
C_dev <- data_all %>%
  filter(trt.stage == "267-hatch" | expt.group == "C") %>%
  select(-starts_with(c("h", "date", "mass", "reason."))) %>%
  mutate("2nd" = jdate.2nd - jdate.hatch,
         "3rd" = jdate.3rd - jdate.hatch,
         "4th" = jdate.4th - jdate.hatch,
