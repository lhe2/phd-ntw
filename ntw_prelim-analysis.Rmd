...
data_all <- read.csv("~/Documents/projects/_not-public/1_data/ntw_data/development_v2.csv", header = T) # change to this bc v1 is missing some info
...
data_v1 <- read.csv("~/Documents/projects/_not-public/1_data/ntw_data/development.csv", header = T)
