...
NTsups_devsumm <- devsumm_Lsups %>% filter.NTs()
...
NTsups_devsumm %>%
  ...
  labs(title = "NTs: average development from 4th - wander", color = "treatment", y = "log(mass (mg))", x = "days to instar",
       caption = "L+F, no pmd, enter at hatch")
  # 231127: hrmmmm this looks... incorrect lol
...
mod_checkNT_survpup1 <-  glm(if.pupa2 ~ trt.stage, data = check_NTstats, family = "binomial")
summary(mod_checkNT_survpup)
...
mod_checkNT_survpup5 <- glm(if.pupa2 ~ meanT*flucT, data = check_NTstats, family = "binomial")
