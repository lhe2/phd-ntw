...
covariates <- c("meanT", "flucT", "minT", "pop", "sex") # some of these vars are basically the same way of subdividing
...
as.data.frame(res)
  ...
  # is the problem testing cox with a categorical var of >2 types?
```
