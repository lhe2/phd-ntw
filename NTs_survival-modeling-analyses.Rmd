...
lets try testing everything at once...
```{r}
...
covariates <- c("trt.stage", "meanT", "flucT", "pop", "sex")
multicoxfitting <- sapply(covariates, function(x) as.formula(paste('Surv(NTall_surv$timeto.exit, NTall_surv$censor)~', x)))
