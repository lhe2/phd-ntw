...
write.csv(export, file = paste0(here("_ntw/data/clean/2023/"), "tent-events.csv"), row.names = FALSE)
...
write.csv(export, file = paste0(here("_ntw/data/clean/2023/"), "tent-matings.csv"), row.names = FALSE)
...
write.csv(export, file = paste0(here("_ntw/data/clean/2023/"), "tent-eggs.csv"), row.names = FALSE)
