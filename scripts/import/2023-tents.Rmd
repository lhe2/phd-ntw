...
# raw
write_csv(dfs_raw[["pairs"]], file = paste0(here("_ntw/data/raw/2023/"), "pairs_", today, ".csv"))
write_csv(dfs_raw[["tents"]], file = paste0(here("_ntw/data/raw/2023/"), "tents_", today, ".csv"))
write_csv(dfs_raw[["hatch"]], file = paste0(here("_ntw/data/raw/2023/"), "hatching_", today, ".csv"))
