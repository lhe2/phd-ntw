...
write.csv(raw, file = paste0(here(bin_paths$y25$ntwdata), "/raw/", today, "_adults.csv"), row.names = FALSE)
...
write.csv(raw, file = paste0(here(bin_paths$y25$ntwdata), "/raw/", today, "_eggs.csv"), row.names = FALSE)
