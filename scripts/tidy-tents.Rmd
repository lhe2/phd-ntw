...
dfs_imported <- list(
  ad25 = read.csv(here(bin_paths$y25$ntwdata, "clean-adults.csv"), header = TRUE),
  coll25 = read.csv(here(bin_paths$y25$ntwdata, "clean-coll.csv"), header = TRUE),
  hatch25 = read.csv(here(bin_paths$y25$ntwdata, "clean-hatch.csv"), header = TRUE)
)
```
...
dfs_imported <- list(
  ad23 = 
    read.csv(here("_ntw/data/clean/2023/tent-pairs.csv"), header = TRUE) %>%
  ...
  coll23 = 
    read.csv(here("_ntw/data/clean/2023/tent-info.csv"), header = TRUE) %>%
    #mutate(across(starts_with("date"), as.Date, "%Y-%m-%d")) %>% 
    filter(id.tent != "107-I"),
  
  hatch23 = 
    read.csv(here("_ntw/data/clean/2023/tent-hatch.csv"), header = TRUE) %>% 
