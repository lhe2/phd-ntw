...
# larva data
dfs_raw <- list(
  field = read.csv(here("data/gsheets/2023/dev-field.csv"), header = TRUE),
  
  labsu = read.csv(here("data/gsheets/2023/dev-su.csv"), header = TRUE),
  
  labF1 = read.csv(here("data/gsheets/2023/dev-F1.csv"), header = TRUE),
  
  labsp = read.csv(here("data/gsheets/2023/dev-sp.csv"), header = TRUE)
)
```
