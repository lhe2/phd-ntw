...
here::i_am("_ntw/scripts/clean/2024-dev.Rmd")
library(here)
```
...
```{r}
df_import <- read.csv(here("_ntw/data/gsheets/2024/dev.csv"), header = TRUE)
```
...
write.csv(export, file = paste0(here("_ntw/data/clean/2024/"), "dev.csv"), row.names = FALSE)
