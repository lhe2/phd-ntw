...
here::i_am("_ntw/scripts/clean/2023-tents.Rmd")
library(here)
```
...
dfs_raw <- list(
  pairs = read.csv(here("_ntw/data/gsheets/2023/tent-pairs.csv"), header = TRUE),
  
  tents = read.csv(here("_ntw/data/gsheets/2023/tents.csv"), header = TRUE),
  
  hatch = read.csv(here("_ntw/data/gsheets/2023/tent-hatch.csv"), header = TRUE)
)
```
