...
hatchinfo <- select(data_tents, c(id.tent, date.hatch, n.hatch, id.coll, notes.hatch))

data_tents <- select(data_tents, -c(date.hatch, n.hatch, id.coll, notes.hatch))

data_tents <- left_join(data_tents, hatchinfo, by = c("id.tent", "date.coll" = "date.hatch"), all = TRUE)
```
...
notes_tents <- select(data_tents, date, id.tent, id.coll, notes.tents, notes.hatch)
